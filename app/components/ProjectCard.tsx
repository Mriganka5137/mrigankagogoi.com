  ...
  return (
    <Card
      className=" flex items-start
       gap-3 overflow-hidden bg-zinc-100 dark:bg-black   hover:border-customGreen transition-all duration-500 ease-in-out w-full max-tablet:flex-col hover:translate-x-2 p-5 min-h-96 shadow-md max-mobile:p-2 "
      id="card"
    >
